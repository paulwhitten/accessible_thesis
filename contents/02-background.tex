...
\begin{figure}[h]
    %\centering
    \includegraphics[width=16.0cm, alt={A milti-layer feed forward neural network}]{./images/multi_layer_ff_nn.png}
...
\begin{figure}[h]
    %\centering
    \includegraphics[width=16.0cm, alt={A comparison of traditional AI to XAI}]{./images/ml_now_xai_future.png}
...
\begin{figure}[h]
    %\centering
    \includegraphics[width=15.0cm, alt={A demonstration of SHAP on five MNIST digits}]{./images/shap_MNIST_Example_3_0.png}
