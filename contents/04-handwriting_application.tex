\chapter{Explainable Methods Applied to Handwritten Characters} \label{ch:handwriting}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/1-0.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/stroke/1-0.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/1-9.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/stroke/1-9.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/8-18.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/stroke/8-18.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/0-28.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/circle/0-28.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/0-19.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/circle/0-19.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/6-18.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/circle/6-18.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/8-20.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/circle/8-20.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/9-16.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/circle/9-16.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/ellipse/0-28.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/ellipse/0-19.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/ellipse/8-20.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/ellipse_circle/8-20.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/3-3.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/crossing/3-3.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/4-5.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/crossing/4-5.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/6-5.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/crossing/6-5.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/endpoint/0-28.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/3-0.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/endpoint/3-0.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/endpoint/8-20.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/endpoint/8-18.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/0-1.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/fill/0-1.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/fill/8-20.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/0-17.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/fill/0-17.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/9-9.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/fill/9-9.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/chull/0-1.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/chull/8-20.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/chull/0-17.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/chull/9-9.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/stroke/3-3.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/line/3-3.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/stroke/4-5.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/line/4-5.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/2-14.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/stroke/2-14.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/line/2-14.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/line/4-5-5pixel.png}
        \caption{}
        \label{fig:line_pixel5}
    \end{subfigure}
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/line/4-5-4pixel.png}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/corner/4-5.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/raw/3-18.png}
        \caption{}
    ...
    \begin{subfigure}{.15\columnwidth}
        \centering
        \includegraphics[width=.90\textwidth, alt={A MNIST digit}]{./images/mnist_transforms/corner/3-18.png}
        \caption{}
